...
## ⚠️ IMPORTANT: THIS IS A HANDOFF COPY

**Official PRD Location**: `uysp-client-portal/docs/features/custom-campaigns/PRD.md`

**All work must be done in**: `uysp-client-portal/` subfolder

This copy is in workspace root for easy handoff visibility only.
