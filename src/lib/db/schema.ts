...
export const leads = pgTable(
  'leads',
  {
    ...
    campaignId: uuid('campaign_id').references(() => campaigns.id, { onDelete: 'set null' }), // Foreign key to campaigns table - Will be populated by backfill, then enforced by migration 0007
